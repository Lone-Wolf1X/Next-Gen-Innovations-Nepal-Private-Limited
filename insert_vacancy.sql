...
SELECT 'ecf142b5-8b2e-4eb4-a046-5f42e689a5b9', @cat_id, 'CTET Complete Preparation', 'Comprehensive preparation course for Central Teacher Eligibility Test (CTET). Includes mock tests and CDP model sets.', CURRENT_DATE, DATE_ADD(CURRENT_DATE, INTERVAL 30 DAY), TRUE, FALSE
FROM DUAL
