...
tar -czvf update.tar.gz learn/admin/ learn/backend/api/ learn/backend/schema.sql learn/backend/schema_live.sql learn/index.html learn/modelset-detail.html learn/course.html learn/js/ learn/test.html learn/result.html learn/profile.html learn/sw.js
